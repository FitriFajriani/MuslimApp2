...
public class ClientAsyncTaskSholat extends AsyncTask<Void, Void,String> {
    ...
    public ClientAsyncTaskSholat(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){
