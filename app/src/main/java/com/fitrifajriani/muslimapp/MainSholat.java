...
public class MainSholat extends AppCompatActivity {
    ...
    private void loadKota() {
        try {
            String api = "/kota";
            ClientAsyncTaskSholat task = new ClientAsyncTaskSholat(this, api, new ClientAsyncTaskSholat.OnPostExecuteListener() {
                @Override
    ...
    private void loadJadwal(int id) {
        try {
            ...
            ClientAsyncTaskSholat task = new ClientAsyncTaskSholat(this, api_url, new ClientAsyncTaskSholat.OnPostExecuteListener() {
                @Override
                public void onPostExecute(String result) {
